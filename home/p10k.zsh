# Generated by Powerlevel10k configuration wizard on 2023-06-30 at 06:27 EDT.
...
() {
  ...
  # Tokyo Night yellow prompt symbol, regardless of last command's exit status.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#e0af68'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND='#e0af68'
