...
if [ -n "$branch" ]; then
  printf "\033[2m%s${reset} \033[2m|${reset} ${tn_magenta}%s${reset} \033[2m|${reset} ${branch_color}%s${reset} \033[2m|${reset} ${ctx_color}%s${reset}" "$model" "$dir_display" "$branch" "$ctx_display"
else
